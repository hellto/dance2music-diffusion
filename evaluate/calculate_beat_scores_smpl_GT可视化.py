...
# 'audio_cache_dir', '../Generate/0129_mean_(1221cls)_origin_latent_unet_newmot_mean_clsloss/feature/',0.225
'audio_cache_dir', '../edge_aistpp/split_music/test_music_feature',
...
def cache_audio_features(seq_names_fulls):
    ...
    for seq_names_full in seq_names_fulls:
        ...
        seq_name = seq_names_full.split(".")[0]
...
#####################################################################
    ...
    for i, seq_name in enumerate(seq_names):
        ...
        #random######################
        # import random
        # seq_name_random = random.choice(seq_names)
        # audio_feature = np.load(os.path.join(FLAGS.audio_cache_dir, f"{seq_name_random}.npy"))  #########f"{audio_name}.npy"
##################
        ...
        # plt.show()
        plt.savefig(f'GT_{seq_name}.png')
        plt.clf()
        ##############################
