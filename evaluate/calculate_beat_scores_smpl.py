...
0220_mean_(1221cls)_origin_latent_unet_newmotclsloss_357219prompt 是去掉了融合编码器的结果
0.169

cmt_generate_wav_npz_1
0.219
0.182
0.200
0.229
...
# 'audio_dir', '../Generate/0220_mean_(1221cls)_origin_latent_unet_newmotclsloss_357219prompt/wav',
# 'audio_dir', '../edge_aistpp/split_music/test_music',

'audio_dir', '../Generate/cmt_generate_wav/cmt_generate_wav_npz_4',
...
# 'audio_cache_dir', '../Generate/0220_mean_(1221cls)_origin_latent_unet_newmotclsloss_357219prompt/feature/',
'audio_cache_dir', '../Generate/cmt_generate_wav/cmt_generate_wav_npz_4_FFF',
...
def cache_audio_features(seq_names_fulls):
    ...
    for seq_names_full in seq_names_fulls:
        ...
        # seq_name = seq_names_full #dmd_sgp独有
